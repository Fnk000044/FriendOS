...
(window as any).electronAPI = {
  ...
  sentimentAnalyze: vi.fn().mockResolvedValue({ sentiment: 'neutral', score: 0.5 }),
  ...
  localModelInit: vi.fn().mockResolvedValue({ success: false }),
  localModelComplete: vi.fn().mockResolvedValue({ response: '' }),
  localModelDispose: vi.fn().mockResolvedValue({ success: true }),
  getCudaStatus: vi.fn().mockResolvedValue({ available: false }),
